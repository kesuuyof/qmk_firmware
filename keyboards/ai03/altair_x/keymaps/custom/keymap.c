...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        MO(3),   KC_TILD, _______, _______, _______, KC_F5,   _______, _______, KC_PLUS, _______, _______, _______, KC_PIPE, _______,
    ...
    [2] = LAYOUT(
        ...
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  MO(3),
                                   _______, _______, _______, _______, _______, _______, _______, KC_ESC
    ),
